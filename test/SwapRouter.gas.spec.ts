import { abi as IPanaromaswapV3PoolABI } from '@panaromaswap/v3-core/artifacts/contracts/interfaces/IPanaromaswapV3Pool.sol/IPanaromaswapV3Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { IPanaromaswapV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IPanaromaswapV3Pool, IPanaromaswapV3Pool, IPanaromaswapV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IPanaromaswapV3PoolABI, wallet)) as [
      IPanaromaswapV3Pool,
      IPanaromaswapV3Pool,
      IPanaromaswapV3Pool
    ]
  ...
  let pools: [IPanaromaswapV3Pool, IPanaromaswapV3Pool, IPanaromaswapV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestPanaromaswapV3Callee')
