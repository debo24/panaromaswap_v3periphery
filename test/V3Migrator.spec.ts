...
import { abi as PAIR_V2_ABI } from '@panaromaswap/v2-core/build/PanaromaswapV2Pair.json'
...
describe('V3Migrator', () => {
  ...
  const migratorFixture: Fixture<{
    factoryV2: Contract
    factoryV3: IPanaromaswapV3Factory
    token: TestERC20
    weth9: IWETH9
  ...
  let factoryV3: IPanaromaswapV3Factory
  let token: TestERC20
  let weth9: IWETH9
  let nft: MockTimeNonfungiblePositionManager
  let migrator: V3Migrator
  let pair: IPanaromaswapV2Pair
  ...
  beforeEach('add V2 liquidity', async () => {
    ...
    pair = new ethers.Contract(pairAddress, PAIR_V2_ABI, wallet) as IPanaromaswapV2Pair
