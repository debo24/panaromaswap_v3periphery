...
contract QuoterV2 is IQuoterV2, IPanaromaswapV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IPanaromaswapV3Pool) {
        return IPanaromaswapV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IPanaromaswapV3SwapCallback
    function panaromaswapV3SwapCallback(
        ...
        IPanaromaswapV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IPanaromaswapV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
